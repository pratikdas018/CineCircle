      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            {ratingStats.count > 0 && (
              <div className="mb-8 max-w-md bg-white dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {movie.Actors.split(", ").map((actor) => (
                    <div key={actor} className="bg-white dark:bg-slate-800 px-4 py-2 rounded-full border border-slate-200 dark:border-slate-700 text-sm text-slate-900 dark:text-slate-100">
                      {actor}
                    </div>
                  ))}
                </div>
